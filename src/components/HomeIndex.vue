      ...
      <router-view style="height:100%"/>
       <div class="style-container">             
        ...
        <div class="layers-container">
            <v-btn @click="showLayer1 = !showLayer1"> X </v-btn>
        </div>
      <MglMap @load="onMapLoad()"  class="mapa" :accessToken="accessToken" :mapStyle="mapStyle" :center="center" :zoom="zoom" > 
...
import COPAGAZ from '../assets/COPAGAZ.geojson'
import lubrificantes from '../assets/Fabrica_de_Lubrificantes_.geojson'
...
export default {
    ...
    data(){
        return {
            ...
            geoJsonLayer: {
                type: 'fill',
                paint: {
                    'fill-color': 'rgba(255,150,180,0.98)',
    ...
    methods:{
        ...
        teste(){
            this.geoJsonLayer.paint['fill-color'] = `blue`
        },
        teste2(){
            this.geoJsonLayer.paint['fill-color'] = `red`
        }
    },
    async mounted(){
